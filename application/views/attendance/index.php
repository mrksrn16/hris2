...
<h3>Attendance<span class="pull-right"><?php echo date('M d Y');?></span></h3>
...
<table class="table table-stripped" id="employee_table">
    ...
    <?php if(count($employees)): foreach($employees as $employee): ?>
        <tr>
            ...
            <td>
                <a href="<?php echo base_url();?>attendance/view/<?php echo $employee->id;?>"><button class="btn btn-primary btn-xs">View</button></a>
            </td>
        </tr>
